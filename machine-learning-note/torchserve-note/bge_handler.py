...
# 在线服务启动命令
torchserve --start --ncs --model-store=/model-store --models bge_large_zh=bge_large_zh.mar --ts-config=/model-store/torchserve.conf --log-config=/model-store/log4j2.xml
torchserve --start --ncs --model-store=/model-store --models bge_large_zh=bge_large_zh.mar --ts-config=/model-store/torchserve.conf --log-config=/model-store/log4j2.xml --foreground
